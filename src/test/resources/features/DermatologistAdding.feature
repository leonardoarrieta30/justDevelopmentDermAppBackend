Feature: Dermatologist Adding
  ...
  Scenario: Add Dermatologist
    When A post Request is sent with values "Elvis Presley", 60, "123456789", "Anywhere", "This is a Description"
  ...
  Scenario: Add Dermatologist with existing Name
    Given A Dermatologist Resource with values "Elvis Presley", 60, "123456789", "Anywhere", "This is a Description" is already stored
